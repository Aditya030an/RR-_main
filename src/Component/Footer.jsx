...
// import { FaArrowRight, FaInstagram, FaLinkedinIn, FaDribbble, FaBehance } from "react-icons/fa6";
...
//             Let’s build <br />
//             something <span className="text-gradient">remarkable.</span>
//           </h2>
//         </motion.div>
...
//             />
//             <button type="submit" className="text-white hover:text-blue-400 transition p-2">
//               <FaArrowRight />
//             </button>
//           </form>
...
import logo from "./photos/design1.png"; // Adjust the path as per your project structure
